...
#include "../../../Classes/Blueprint/SRDisplayDrawBoxComponent.h"
...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USRDisplayDrawBoxComponent_Statics::NewProp_LineThickness = { "LineThickness", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(USRDisplayDrawBoxComponent, LineThickness), METADATA_PARAMS(Z_Construct_UClass_USRDisplayDrawBoxComponent_Statics::NewProp_LineThickness_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USRDisplayDrawBoxComponent_Statics::NewProp_LineThickness_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USRDisplayDrawBoxComponent_Statics::NewProp_TargetScale = { "TargetScale", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(USRDisplayDrawBoxComponent, TargetScale), METADATA_PARAMS(Z_Construct_UClass_USRDisplayDrawBoxComponent_Statics::NewProp_TargetScale_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USRDisplayDrawBoxComponent_Statics::NewProp_TargetScale_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USRDisplayDrawBoxComponent_Statics::NewProp_DisplayWidth = { "DisplayWidth", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(USRDisplayDrawBoxComponent, DisplayWidth), METADATA_PARAMS(Z_Construct_UClass_USRDisplayDrawBoxComponent_Statics::NewProp_DisplayWidth_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USRDisplayDrawBoxComponent_Statics::NewProp_DisplayWidth_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USRDisplayDrawBoxComponent_Statics::NewProp_DisplayHeight = { "DisplayHeight", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(USRDisplayDrawBoxComponent, DisplayHeight), METADATA_PARAMS(Z_Construct_UClass_USRDisplayDrawBoxComponent_Statics::NewProp_DisplayHeight_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USRDisplayDrawBoxComponent_Statics::NewProp_DisplayHeight_MetaData)) };
	...
	USRDisplayDrawBoxComponent::~USRDisplayDrawBoxComponent() {}
	struct Z_CompiledInDeferFile_FID_release_srd_ue_plugin_ReleasePlugin_srd_ue_plugin_5_2_SRDisplayPlugin_HostProject_Plugins_SRDisplayPlugin_Source_SRDisplayModule_Classes_Blueprint_SRDisplayDrawBoxComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_release_srd_ue_plugin_ReleasePlugin_srd_ue_plugin_5_2_SRDisplayPlugin_HostProject_Plugins_SRDisplayPlugin_Source_SRDisplayModule_Classes_Blueprint_SRDisplayDrawBoxComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USRDisplayDrawBoxComponent, USRDisplayDrawBoxComponent::StaticClass, TEXT("USRDisplayDrawBoxComponent"), &Z_Registration_Info_UClass_USRDisplayDrawBoxComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USRDisplayDrawBoxComponent), 2955876120U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_release_srd_ue_plugin_ReleasePlugin_srd_ue_plugin_5_2_SRDisplayPlugin_HostProject_Plugins_SRDisplayPlugin_Source_SRDisplayModule_Classes_Blueprint_SRDisplayDrawBoxComponent_h_4240163577(TEXT("/Script/SRDisplayModule"),
		Z_CompiledInDeferFile_FID_release_srd_ue_plugin_ReleasePlugin_srd_ue_plugin_5_2_SRDisplayPlugin_HostProject_Plugins_SRDisplayPlugin_Source_SRDisplayModule_Classes_Blueprint_SRDisplayDrawBoxComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_release_srd_ue_plugin_ReleasePlugin_srd_ue_plugin_5_2_SRDisplayPlugin_HostProject_Plugins_SRDisplayPlugin_Source_SRDisplayModule_Classes_Blueprint_SRDisplayDrawBoxComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
